...
REGISTRY ?= docker.pkg.github.com/serhijko/go-project-blueprint

# This version-strategy uses git tags to set version string
...
###
### These variable should not need tweaking.
###
...
TEST_IMAGE ?= serhijko/golang:1.12-alpine-test
